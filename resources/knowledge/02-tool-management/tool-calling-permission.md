...
- [tool-schema-validation] 工具 schema 和参数校验
- [tool-risk-policy] 风险分级与 PermissionGate
- [tool-approval-lifecycle] approve / deny / 自动恢复闭环
- [tool-audit-events] RunEvent 和 audit log
